...
class WebImageWorker:
    """Thu thập ảnh từ DuckDuckGo theo keyword.
    ...
    def run(self):
        ...
        self._log(f"Nguồn: DuckDuckGo | Max/keyword: {max_num} | Min size: {min_w}×{min_h}")
        ...
        for kw in keywords:
            ...
            self._push()
            self._collect_keyword(kw, out_root, max_num, min_w, min_h, size_tag)
